        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h4 class="panel-title text-center">Listado de proyectos sin tutor(a) </h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
$sql="SELECT proyectos.titulo,proyectos.id AS'id_proyecto' FROM 
estudiante,pnfs,proyectos,est_cursa_proy,est_tiene_proy,tutor_tiene_proyectos WHERE
...
id_profesor='0' AND
nomb_pnf='".$z['area_especializacion']."' ";
...
sweetAlert("Disculpe", "No hay proyectos pendientes por asignar tutor", "error");
});
...
?>
              <form action='tutor_asignado.php' name='form' method='post' >
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><center>Titulo del proyecto</center></th>
                ...
                <tbody>
                                            ...
                                            for($i=0; $i<$fila;$i++){ ?>
                                            <tr>
                                            <td ><p><?php echo $fila['titulo'];?></p></td>
                                            <td >
											<center>

											<select name='id_profesor[]' id='id_profesor' style='width:180px;' class='form-control' required>
                      <option value=""> Seleccione un tutor </option>
                                            <?php
											$sql="SELECT * FROM profesores where ci!='".$z['ci']."' ORDER BY apellidos";
											$rs=mysql_query($sql);
