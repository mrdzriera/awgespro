...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Consultas de proyecto/ Informes</h1> 
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Mostrar informes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
<?php
...
estudiante.nombres AS'nom', 
estudiante.apellidos
FROM usuarios,estudiante,pnfs,trayectos,anios,sedes,est_cursa_proy,
proyectos, est_tiene_proy, proyectos_tiene_documento
WHERE 
...
sweetAlert("Disculpe", "No hay proyectos con informes registrados", "error");
});
...
?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td ><p align='justify'><?php 
				echo $fila['nom'].'&nbsp;'.$fila['apellidos'].'&nbsp;CI&nbsp;'.$fila['ci'];
				if(mysql_num_rows($r2)==1){
				echo "<br>".$row2['nombres'].'&nbsp;'.$row2['apellidos'].'&nbsp;CI&nbsp;'.$row2['ci'];	
				}
				if(mysql_num_rows($r3)==1){
				echo "<br>".$row3['nombres'].'&nbsp;'.$row3['apellidos'].'&nbsp;CI&nbsp;'.$row3['ci'];	
				}
				?></p></td>
				<td align='center'><center><?php echo $fila['nomb_pnf'];?></center></td>
				<td align='center'><center><?php echo $fila['descripcion'];?></center></td>
				<td align='center'><center><?php echo $fila['periodo'];?></center></td>
				<td align='center'><center><?php echo $sedep;?></center></td>
				
				<td align='center'><a target="_blank" href="informe_descargado.php?id_proyecto=<?php echo $fila['id_proyecto']?>&informe=<?php echo $fila['informe'];?>"><img src="imagenes/buscar.png" style="width:30px; height:30px;"></a></a></td>
				<td align='center'><a target="_blank" href="informe_falso_quitado.php?id_proyecto=<?php echo $fila['id_proyecto']?>&informe=<?php echo $fila['informe'];?>&ci=<?php echo $fila['ci'];?>"><img src="imagenes/eliminar.png" style="width:30px; height:30px;"></a></a></td>
                </tr>
				<?php  
				$fila=mysql_fetch_array($bus);
				}  
