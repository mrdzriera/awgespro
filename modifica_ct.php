...
<div class="wrapper">
 ...
 <?php
		...
		$id=$_GET['id'];
		$query="SELECT * FROM coordinador_trayecto WHERE id='".$id."' ";
    ...
    <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box box-info">
                  ...
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form class="form-horizontal" action="ct_modificado.php" name="form" method="post">
                    <div class="box-body panel-title text-center">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_pnf" id="id_pnf" class="form-control" required>
                        ...
                        <label for="inputEmail3" class="col-sm-3 control-label" align="right">Trayecto</label>
                         ...
                         <div class="col-sm-6">
                          <select  name="id_trayecto" id="id_trayecto" title="Seleccione una Opcion" class="form-control" value="" required> 
                          <option value="">Seleccione una opci&oacute;n</option>
                    ...
                    <div class="box-footer">
                      <center>
                      <button type="submit" class="btn btn-info"><i class="fa fa-share"></i> Guardar </button>
                      </center>
                    </div>
                    <!-- /.box-footer -->
                  </form>
