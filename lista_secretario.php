        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Listado de secretario(s)</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  <?php
                ...
                $sql="SELECT nombres,apellidos,secretarios.ci,usuarios.telefono,correo,usuarios.id
                 FROM secretarios,usuarios WHERE usuarios.ci=secretarios.ci ORDER BY apellidos";
                $r=mysql_query($sql);
				//echo $sql;
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <a onclick="return confirm('Esta seguro que desea eliminar?')" href="confirm_elimusu.php?campo=secretarios&ci=<?php echo $row['ci'];?>&id_usuario=<?php echo $row['id'];?>"><img src="imagenes/eliminar.png" style="width:30px; height:30px;"></a>
                       </td>
                       </tr>
                               <?php  $row=mysql_fetch_array($r);
                          } }?>
