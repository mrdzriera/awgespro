...
if($_SESSION['tipocuentas']!='Administrador'){
  ?>
<script language="javascript" type="text/javascript">window.location="index.php";
</script>
<?php  
}
?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Consultas de proyecto/Evaluaci&oacute;n   
      </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default panel-with-tabs" data-sortable-id="ui-widget-9">
                    <div class="panel-heading">
                        <h4 class="panel-title text-center">Evaluaci&oacute;n del proyecto</h4>
...
$fase=$_POST['fase'];
	...
	estudiante.ci= '".$ci."' AND fase= '".$fase."' AND anios.periodo='".$anio."' ";
...
?>
		...
		sweetAlert("Disculpe", "No hay Evaluaciones Registradas con este Lider en esta fase para este periodo academico", "error");
		 });
		function redireccionar(){
		window.location="consultas_adm.php";
		}
...
<center>
    ...
    <table class="table table-bordered table-striped">
		<tr>
	<td ><center><strong>Titulo de proyecto</strong></center></td>
	...
	<tr>	
		...
		<td ><center><p align='justify'><?php echo $fila['titulo'];?></p></center></td>
		<td ><center><?php echo $fila['nomb_pnf'];?></center>	</td>
	   <td ><center><?php echo $fila['descripcion'];?></center>	</td>
	   <td ><center><?php echo $fila['periodo'];?></center>	</td>
...
$row2=mysql_fetch_array($r2);
		...
		<td><center><b>Nota definitiva en la fase <?php echo $row2['fase'];?>:</b></center></td>
		</tr>
		<tr>
