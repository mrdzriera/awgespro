  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1 class="panel-title text-center">
        Registros/C&oacute;digos/En curso
      </h1>
    </section>
      ...
      <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="registrar_codigo.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  operaciones.nombre='Registrar Codigos' AND
                  ...
                  ?>  
                  <script language="javascript">
                  alert("Disculpe", "Usted aun no esta autorizada para registrar códigos a los proyectos", "error");
                  ...
                  <div class="col-sm-6">
                   <select name="sede" id="sede" class="form-control"   required>
                    <option value="">Seleccione una opci&oacute;n</option>
                    <option value="Sede Victoria">Sede Principal la Victoria</option>
