...
window.location="consulta_factibilidad_coord.php";
}
...
<a target="_blank" href="reporte_proyecto_filtros.php?forma=<?php echo $forma;?>&accion=<?php echo $accion;?>&anio=<?php echo $anio;?>&nomb_pnf=<?php echo $nomb_pnf;?>&num_trayecto=<?php echo $num_trayecto?>&num_seccion=<?php echo $num_seccion;?>&turno=<?php echo $turno?>&sede=<?php echo $sede;?>">

<a target="_blank" style="color:gray;" href="graficos_coord.php?accion=<?php echo $accion;?>&forma=<?php echo $forma;?>&anio=<?php echo $anio;?>&nomb_pnf=<?php echo $nomb_pnf;?>&num_trayecto=<?php echo $num_trayecto?>&num_seccion=<?php echo $num_seccion;?>&sede=<?php echo $sede;?>&turno=<?php echo $turno;?>">

<img src="imagenes/grafico.png" style="width:30px; height:30px;">
<b style="color:gray;">Ver gr&aacute;fico </b></a></center>
