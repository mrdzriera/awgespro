...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Usuarios/Consultar/Estudiantes      
      </h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Listado de estudiantes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                          <?php
            ...
            $sql="SELECT * FROM estudiante,usuarios,pnfs,trayectos,secciones,anios,turnos,sedes,est_cursa_proy WHERE
            ...
            sedes.nombre='".$sede."' ORDER BY apellidos";
            $r=mysql_query($sql);
...
<?php $row=mysql_fetch_array($r);
                    ...
                    <a onclick="return confirm('Esta seguro que desea eliminar?')" target="_self"  href="confirm_elimusu.php?campo=estudiantes&ci=<?php echo $row['ci'];?>&id_usuario=<?php echo $row['id'];?>"><img src="imagenes/eliminar.png" style="width:30px; height:30 px;"></a>
                      </td>
                       </tr>
                               <?php  $row=mysql_fetch_array($r);
                          } ?>
