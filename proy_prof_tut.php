...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Profesores asignados como tutores</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    <?php
	...
	FROM profesores,proyectos,anios,pnfs,tutor_tiene_proyectos,estudiante,est_cursa_proy,est_tiene_proy WHERE
                ...
                <tbody>
					<?php
                      while($row=mysql_fetch_array($r)){
						...
						$m="SELECT COUNT(*)AS'cant' FROM profesores,proyectos,anios,pnfs,tutor_tiene_proyectos,estudiante,est_cursa_proy,est_tiene_proy WHERE
						estudiante.id=est_cursa_proy.id_estudiante AND
						pnfs.id=est_cursa_proy.id_pnf AND
						anios.id=est_cursa_proy.id_anio AND
						anios.id=proyectos.id_anio AND
                      ...
                      <td align='center'><?php echo $o['cant'];?></td>
