  ...
  <div class="content-wrapper" id="contenido">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <h2 class="panel-title text-center"><b> Sistema para la gesti&oacute;n de proyectos <BR>(AWGESPRO)<BR> </b></h2>
            ...
            <form class="form-horizontal" action="usuario_modificado.php" name="form" method="post" onsubmit="return verifica_clave();">
              <div class="box-body panel-title text-center">
                  ...
                  <img src="imagenes/logo-upta.png" style="width: 180px; height:170px;">

              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <center>
              <strong style="color:black;"> - Disfrute de nuestros servicios - </strong>
                </center>
              </div>
              <!-- /.box-footer -->
            </form>
