...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	?>
      ...
      Proyectos/Retiros/<?php if($retiro=='integrantes'){ echo "Integrantes"; }else if($retiro='investigacion'){ echo "Investigacion"; }?>
      </h1>
    ...
    <section class="content">
      ...
      <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="mostrar_retiro.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  <div class="col-sm-6">
                   <input type="text" name="ci_1" class="form-control" id="inputEmail3" placeholder="12345678" onkeypress="return solonumeros(event);" onpaste="return false" maxlength="8" required=""> 
                  ...
                  <div class="col-sm-6">
                    ...
                    $db= new clasedb();
                    $db->conectar();
                    $sql="SELECT MAX(periodo) AS'periodo' FROM anios";
                    $r=mysql_query($sql);
                    $row=mysql_fetch_array($r);
                    ?>

                   <input type="hidden" name="retiro" value="<?php echo $retiro;?>">
                   <input type="hidden" name="cip" value="<?php echo $_SESSION['cedula_usu'];?>">
                   </div>
				   
				    <div class="col-sm-6">
                   <input type="text" name="anio" class="form-control" onkeypress="return solonumeros(event);"  required 
				   value="<?php echo $row['periodo'];?>" readonly> 
                  </div><img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; " align="Left" />
