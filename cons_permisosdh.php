  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1 class="panel-title text-center">
       Permisos/Forma General/Deshabilitar 
      </h1>

         <form action="deshabilitar.php" name="form" method="post">
         <div class="col-md-8 col-md-offset-2">  

                <div class="box box-info">

                     <div class="box-header with-border"><br>
					   <center><strong>Deshabilitar Privilegios de Usuario</strong></center>
 	  ...
 	  <center>
		  <select name="tipo_usuario" id="tipo_usuario" class="form-control-sel" required>
