...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Socializaci&oacute;n/Evaluaciones
      </h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Registrar evaluaci&oacute;n final</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
FROM estudiante,est_tiene_proy,proyectos,profesores,coord_tiene_proy,proyectos_tiene_eva_def WHERE 
...
sweetAlert("Disculpe", "Usted no tiene proyectos pendientes por registrar evaluacion final", "error");
});
...
?>
              <form action='evaldef_registrada.php' name='form' method='post' >
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                 <th><center>Lider</center></th>
                  <th><center>Coordinador</center> </th>
                  <th><center>Tutor</center></th>
                  <th><center>Especialista 1</center></th>
                  <th><center>Especialista 2</center></th>
                  <th><center>Especialista 3</center></th>
                  <th><center>Comunidad</center></th>
                </tr>
                </thead>
                <tbody>
               ...
               <td align='center'>
                ...
                <td align='center'>
				<select name="cal_e1[]" id="cal_e1" class="form-control" required> 
				<option value="">Seleccione</option>
				<?php
				for($y=1;$y<=100;$y++){
				?>
				...
				<td align='center'>
				<select name="cal_e2[]" id="cal_e2" class="form-control" required> 
				<option value="">Seleccione</option>
				<?php
				for($y=1;$y<=100;$y++){
				?>
				...
				<td align='center'>
				<select name="cal_e3[]" id="cal_e3" class="form-control" required> 
				<option value="">Seleccione</option>
				<?php
				for($y=1;$y<=100;$y++){
				?>
				...
				?>
					...
					<td align='center'>
					<select name="cal_com[]" id="cal_com" class="form-control" required> 
					<option value="">Seleccione</option>
				<?php
				for($y=1;$y<=100;$y++){
				?>
