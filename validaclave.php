   ...
   <section class="content">
    	 <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="modificar_clave.php" name="form" method="post" onsubmit="return verifica_clave();">
              <div class="box-body panel-title text-center">
			  
			  <div class="box-header with-border">
            <center> <b>¡IMPORTANTE!</b> <br> Para modificar su clave debera confirma la clave que tiene actualmente.</center>
            </div>
