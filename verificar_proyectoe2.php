                   ...
                   <form action='factibilidad_registrada.php' name='form' method='post' >
                                ...
                                <center>
                                     ...
                                     <tbody>
											...
											<select type='text' name='opn_esp2[]' class="form-control-sel" style="width:130px" id='opn_esp2' required>;
										   <option value='0'> Sin asignar</option>
											...
											<input type="hidden" name="id_estudiante3" id="id_estudiante3" value="<?php echo $fila['id_estudiante3'];?>">
											 <a target="_blank" href="planilla_inscripcion.php?id=<?php echo $fila['id'];?>" ><img src="imagenes/pdf.jpg" style="width:20px;height:20px;" ></a></td>
											</tr>
                                            <?php  $fila=mysql_fetch_array($bus);
} ?>
                                      </tbody>
...
?>				<?php while($row=mysql_fetch_array($r)){ ?>
                <tr>
                  ...
                  <td><a target="_blank" href="planilla_inscripcion.php?id=<?php echo $row['id'];?>" ><img src="imagenes/pdf.png" style="width:20px;height:20px;" ></a></td>
                </tr>
															<?php }
