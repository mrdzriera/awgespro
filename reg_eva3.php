...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Registros/Evaluaciones/Fase 3</h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Registrar evaluaci&oacute;n en la fase 3</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
<script language="javascript" type="text/javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "Usted no tiene proyectos pendientes por evaluar en la fase 3", "error");
});
function redireccionar(){
window.location="consulta_evaluacion.php";
}
...
?>
              <form action='evaluacion_registrada3.php' name='form' method='post' >
