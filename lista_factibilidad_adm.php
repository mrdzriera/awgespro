...
window.location="consulta_factibilidad_adm.php";
}
...
<a target="_blank"target="_blank" href="reporte_proyecto_filtros.php?forma=<?php echo $forma;?>&accion=<?php echo $accion;?>&anio=<?php echo $anio;?>&pnf=<?php echo $nomb_pnf;?>&trayecto=<?php echo $num_trayecto?>&seccion=<?php echo $num_seccion;?>&turno=<?php echo $turno?>&sede=<?php echo $sede;?>">

<img src="imagenes/pdf.png" style="width:30px; height:30px;"> 
 <b style="color:gray;"> Ver pdf </b> </a>&nbsp;&nbsp;
<a  href="graficos.php?accion=<?php echo $accion;?>&forma=<?php echo $forma;?>&anio=<?php echo $anio;?>&nomb_pnf=<?php echo $nomb_pnf;?>&num_trayecto=<?php echo $num_trayecto?>&num_seccion=<?php echo $num_seccion;?>&sede=<?php echo $sede;?>&turno=<?php echo $turno;?>">
