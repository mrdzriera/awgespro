...
<section class="content">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="controlador_defensa.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                ...
                <?php
                  ...
                  operaciones.nombre='Registrar Presentaciones' AND
                  ...
                  ?>  
                  <script language="javascript">
                  alert("Disculpe Ud aun no esta autorizado para registrar presentaciones a los proyectos");
                  ...
                  <div class="col-sm-6 col-sm-offset-3">
                   ...
                   <select name="fase" id="opcion" class="form-control" required="">
