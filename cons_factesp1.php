...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Registros/Factibilidad/Especialista</h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Asignar factibilidad como especialista 1</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
<script language="javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "No hay un proyectos pendientes por opinar factibilidad donde su posicion sea especialista", "error");
});
function redireccionar(){
...
?>
              ...
              <th class="text-center">Verificar</th>
               ...
               <td ><p align='center'><?php echo $fila['des_tur'];?></p></td>
                ...
                <td align='center'><input name='<?php echo $obs;?>[]' style="width:170px" size="15" class="form-control" maxlength="60" placeholder="Maximo 60 caracteres" /></td>                                          
                <td align='center'>
                ...
                <input type="hidden" name="id_estudiante3" id="id_estudiante3" value="<?php echo $fila['id_estudiante3'];?>">
                 ...
                 <a href="verificar_proyectoe1.php?id=<?php echo $fila['id_proyecto'] ?>" ><img src="imagenes/buscar.png" style="width:30px; height:30px;" ></a></td>
				 </tr>
