...
<section>
         ...
         <form action="regproy_deshabilitado.php" name="form" method="post">
...
<section>
         ...
         <form action="regevadef_deshabilitado.php" name="form" method="post">
         <div class="col-md-8 col-md-offset-2">  
...
<section>
         ...
         <form action="regcod_deshabilitado.php" name="form" method="post">
         <div class="col-md-8 col-md-offset-2">  
