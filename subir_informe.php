	...
	<div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <h2 class="panel-title text-center">Todos los campos con (<img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; ">) son obligatorios</h2>
               ...
               <div class="box-header with-border">
            <center> <b>¡IMPORTANTE!</b> <br> Solo puede adjuntar archivos pdf</center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action='informe_subido.php' method='post' enctype='multipart/form-data' name='form' onsubmit="return validaarchivo();">
              <div class="box-body panel-title text-center">
                
                  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Informe</label>

                  <div class="col-sm-6">
                  <input type='hidden' class='form-control' value="<?php echo $row['id_proyecto']?>" name='id_proyecto' size='30'>
				  
				  <input type='file' class='form-control' value="<?php
				  if(($row['informe']!="No")and($row['informe']!="")){
				  echo $row['informe;'];
				  }else{
					  
				  }
				  ?>"required="" name='informe' size='30'>
