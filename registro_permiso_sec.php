...
$sql="SELECT *,
proyectos.id AS'id',
estudiante.nombres,estudiante.apellidos,turnos.descripcion,trayectos.num_trayecto
FROM proyectos,estudiante,est_tiene_proy,proyectos_tiene_permiso,pnfs,turnos,sedes,trayectos,est_cursa_proy WHERE 
...
?>
              <form action='permiso_registrado_sec.php' name='form' method='post' >
