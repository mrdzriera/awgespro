...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Consultas de proyecto/Culminaci&oacute;n
      </h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Culminaci&oacute;n de proyecto</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
	<?php 
	...
	$busqueda="SELECT titulo,nomb_pnf,descripcion,num_seccion,proyectos_tiene_culminacion.fecha,proyectos.id,aprobacion
	FROM proyectos,estudiante,pnfs,trayectos,secciones,anios,est_cursa_proy,est_tiene_proy,
	culminacion_proyecto,proyectos_tiene_culminacion 
	WHERE
	...
	culminacion_proyecto.id=proyectos_tiene_culminacion.id_culminacion AND 
...
?>
        <script type="text/javascript">
			...
			sweetAlert("Disculpe", "No hay Proyectos culminados en este periodo academico", "error");
			});
			function redireccionar(){
			window.location="consultas_coord.php";
			}
...
?>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$fecha=$dia.$mes.$anio;
				 ...
				 <td align='center'><center><?php echo $fecha;?></center></td>
				 <td align='center'><center><?php echo $row['aprobacion'];?></center></td>
				 <td align='center'><a target="_blank" href="planilla_inscripcion.php?id=<?php echo $row['id']?>"><img src="imagenes/pdf.png" style="width:30px; height:30 px;"></a></td>
                  </tr>
                  <?php 
				  }
                  }
