...
<section class="content">
      ...
      <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="controlador_evaluaciones.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                ...
                ?>  
                <script language="javascript">
                alert("Disculpe Ud aun no esta autorizado para registrar evaluaciones a los proyectos");
