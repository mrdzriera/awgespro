...
$sql="SELECT proyectos.id,estudiante.nombres,estudiante.apellidos,nomb_pnf,trayectos.descripcion,secciones.num_seccion,anios.periodo,turnos.descripcion AS'des_tur' FROM estudiante,est_cursa_proy,proyectos,pnfs,trayectos,secciones,turnos,anios,profesores,est_tiene_proy,coord_tiene_proy WHERE
...
if(mysql_num_rows($r)==0){
  ...
  $(document).ready(function(){
	sweetAlert("Disculpe", "Usted no tiene proyectos como coordinador en este periodo academico", "error");
	});
