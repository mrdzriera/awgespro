...
<section class="content">
    ...
    <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="controlador_opciones.php" name="form" method="post">
                ...
                <?php
				 ...
				 permisos.id='1'";
                  ...
                  <div class="col-sm-6 col-sm-offset-3">
                    ...
                    if(mysql_num_rows($r23)==1){
                    ?>
                    <option value="culminacion">Culminaci&oacute;n</option>
                    <?php 
                    }
                    ?>
                    </select>
