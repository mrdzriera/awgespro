...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Registros/Factibilidad/Especialista 2</h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Asignar factibilidad como especialista 2</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
<script language="javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "No hay un proyectos pendientes por opinar factibilidad donde su posision sea especialista 2", "error");
});
function redireccionar(){
...
?>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <td ><p align='center'><?php echo $fila['des_tur'];?></p></td>
                ...
                <select type='text' name='opn_esp2[]' class="form-control" style="width:130px" id='opn_esp1' required>;
				        <option value='0'> Sin asignar</option>
                <option value='Si'> Factible</option>
                <option value='No'> No factible</option>
                </select></td>
                <td align='center'><input name='obs_esp2[]' size="15" class="form-control" maxlength="60" placeholder="Maximo de 60 caracteres"/></td>                                          
                <td align='center'>
                ...
                <input type="hidden" name="id_estudiante3" id="id_estudiante3" value="<?php echo $fila['id_estudiante3'];?>">
                 <a target="_blank" href="planilla_inscripcion.php?id=<?php echo $fila['id'];?>" ><img src="imagenes/pdf.pdf" style="width:30px; height:30px;" ></a></td>
                  <td align='center'>

                 <a href="verificar_proyectoe2.php?id=<?php echo $fila['id_proyecto'] ?>" ><img src="imagenes/buscar.png" style="width:30px; height:30px;" ></a></td>
				 </tr>
                 <?php  $fila=mysql_fetch_array($bus);
				 } 
				 ?>
