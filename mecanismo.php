        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Registro de eventos</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
<?php
...
sweetAlert('Disculpe', 'Las fechas son incorrectas', 'error');
});
...
$sql="SELECT historial.*,usuarios.usuario FROM historial,usuarios WHERE 
usuarios.id=historial.id_usuario AND 
fecha BETWEEN '".$fdesde."' AND '".$fhasta."' 
GROUP BY operacion ORDER BY id DESC ";
...
<script language="javascript" type="text/javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "No se encuentran registros para mostrar en la fecha indicada", "error");
});
function redireccionar(){
window.location="verificarclave.php?opc=1";
}
