...
?>
         ...
         <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="lista_factibilidad_coord.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  <div class="col-sm-6">
                  <input type="text" name="nomb_pnf" class="form-control" id="nomb_pnf" title="Seleccione una Opcion" value="<?php echo $data['area_especializacion'];?>" readonly>
                  </div><img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; " align="Left" />
                </div>
                  ...
                  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Turno</label>
                  ...
                  <div class="col-sm-6">
                  <select  name="sede" id="sede" title="Seleccione una Opcion" class="form-control" value="" required=""> 
                   <option value="">Seleccione una opci&oacute;n</option>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Accion</label>
