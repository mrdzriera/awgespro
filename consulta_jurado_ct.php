    ...
    <section class="content">
       ...
       <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="lista_jurados_ct.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                
                <div class="form-group">
                  <label for="inputEmail3" class="col-md-3 control-label" align="right">C.I del lider</label>

                  <div class="col-sm-6">
                  <input  type="text" onkeypress="return solonumeros(event);" maxlength="8" onpaste="return false" id="textValidReg" placeholder="12345678"  name="ci"  class="form-control" required>
