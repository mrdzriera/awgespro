...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        Comit&eacute; t&eacute;cnico/Profesores/Consultar
      </h1>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Consultar profesores</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  <?php
        ...
        $sql="SELECT * FROM profesores,usuarios,comite_tecnico 
        WHERE 
