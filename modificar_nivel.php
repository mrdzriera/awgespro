  ...
  <div class="content-wrapper">
    ...
    <h1 class="panel-title text-center">
      Usuarios/Modificar        
          ...
          if ((mysql_num_rows($r)==0)or($vericlave==0)){
          ?>
          <script language="javascript" type="text/javascript"> 
          $(document).ready(function(){
          sweetAlert("CLAVE INCORRECTA", "", "error");
          });
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="nivel_modificado.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  <div class="col-sm-6">
                  <input type="text" maxlength="8" name="ci" class="form-control" onkeypress="return solonumeros(event);" placeholder="12345678" required/>
                  <input type="hidden" name="usuario" value="<?php echo $_SESSION['nombre_usu'];?>">
                     ...
                     <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Nivel</label>

                  <div class="col-sm-6">
                 <select type="text" maxlength="8" name="nivel" class="form-control"  required/>
