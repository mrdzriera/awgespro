...
<div class="wrapper">
  ...
  <section class="content-header">
      ...
      Proyectos/Asignar Coordinador de trayecto
      </h1>
    ...
    <section class="content">
       ...
       <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="asignar_coord_tray.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  <div class="col-sm-6">
                   <select name="nomb_pnf" id="nomb_pnf" class="form-control" required>
