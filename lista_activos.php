...
?>
    ...
    Usuarios/<?php echo $tipo;?>/Activos</h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Listado de <?php echo $tipo;?> Activos </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
nivel='Estudiante' AND usuarios.status='Activo' ";

}else if($tipo=='Coordinadores'){
  
$busqueda="SELECT *,usuarios.id,usuarios.ci FROM profesores,usuarios WHERE profesores.ci=usuarios.ci AND 
 nivel='Coordinador' AND usuarios.status='Activo'";
...
$busqueda="SELECT *,usuarios.id,usuarios.ci FROM secretarios,usuarios WHERE secretarios.ci=usuarios.ci AND 
 nivel='Secretario' AND usuarios.status='Activo'";
...
sweetAlert("Disculpe", "No hay usuarios activos con este nivel", "error");
});
...
?>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                                            ...
                                            <td ><p align='center'><?php echo $fila['telefono'];?></p></td>
