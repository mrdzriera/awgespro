       ...
       <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <h2 class="panel-title text-center">Todos los campos con (<img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; ">) son obligatorios</h2>
             ...
             <div class="box-header with-border">
            <center> <b>¡IMPORTANTE!</b> <br> Para eliminar este coordinador de trayecto debe confirmar la contrase&ntilde;a del administrador</center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="ct_eliminado2.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                  ...
                  <div class="col-sm-6">
                  <input type="password" maxlength="17" name="clave" class="form-control" placeholder="Contrase&ntilde;a" required/>
