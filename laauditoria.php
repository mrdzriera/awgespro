    ...
    <section class="content-header">
      ...
      <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="mecanismo.php" name="form" method="post">
              <div class="box-body panel-title text-center">
                
                  <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Desde</label>

                  <div class="col-sm-6">
                  <input type="date" id="fechad"  size="10" name="fdesde" class="form-control"  required="required"/>
                  </div><img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; " align="Left" />
                </div>

                     <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label" align="right">Hasta</label>

                  <div class="col-sm-6">
                   <input type="date" id="fechah"  size="10" name="fhasta" class="form-control"  required="required" />
                  </div><img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; " align="Left" />
                </div>
            ...
            window.location="verificarclave.php?opc=1";
            }
