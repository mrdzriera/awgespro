...
$busqueda="SELECT *,estudiante.ci AS'ci_est',proyectos.id,nomb_pnf,profesores.id AS'id_profesor',
...
proyectos_tiene_comite,proyectos_tiene_opinion ,
...
<?php
                  ...
                  <th><center>Opini&oacute;n<center></th>
                  ...
                  <th><center>Ver pdf<center></th>
                      ...
                      $fila=mysql_fetch_array($bus);
                        if($fila['id_profesor']==$fila['id_comite1']){
                      $opn="opn_esp1";
                      $obs="obs_esp1";
                      }else if($fila['id_profesor']==$fila['id_comite2']){
                      $opn="opn_esp2";
                      $obs="obs_esp2";
                      }else if($fila['id_profesor']==$fila['id_comite3']){
                      $opn="opn_esp3";
                      $obs="obs_esp3";
                      }
                    ...
                    <td ><p align='center'><?php echo $fila['nomb_pnf'];?></p></td>
                     ...
                     <td ><p align='center'><?php echo $fila['num_seccion'];?></p></td>
                     <td ><p align='center'><?php echo $fila['periodo'];?></p></td>
                     <td ><p align='center'><?php echo $fila['des_tur'];?></p></td>
                      <td align='center'><input type='hidden' name='indice' value='<?php echo $cont;?>' size='1' max-length='20' placeholder='Cedula Estudiantil' readonly title='Cedula'/>
                      ...
                      <select type='text' name='<?php echo $opn;?>[]' class="form-control" style="width:130px" id='opn_esp1' required>;
                      <option value=''> Seleccione </option>
                      <option value='Si'> Factible</option>
                      <option value='No'> No factible</option>
                      </select></td>
                      <td align='center'><input name='<?php echo $obs;?>[]' style="width:170px" size="15" class="form-control" maxlength="60" placeholder="Maximo 60 caracteres" required/></td>                                          
                      <td align='center'>
                      ...
                      <input type="hidden" name="id_estudiante3" id="id_estudiante3" value="<?php echo $fila['id_estudiante3'];?>">
                       <a target="_blank" href="planilla_inscripcion.php?id=<?php echo $fila['id'];?>" ><img src="imagenes/pdf.png" style="width:30px; height:30 px;" ></a></td>
                        <td align='center'>
                       </td>
                      </tr>
                            ...
                            <center><button type="submit" class="btn btn-info pull"> <i class="fa fa-check" ></i>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Verificar plagio de proyecto</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
