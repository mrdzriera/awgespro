            ...
            <div class="col-md-13">
                ...
                <div class="panel panel-default panel-with-tabs" data-sortable-id="ui-widget-9">
                    <div class="panel-heading">
                        <center><h4 class="panel-title text-center">Asignar Factibilidad de Proyecto</h4></center>
...
<?php
                   ...
                   <form action='factibilidad_registrada.php' name='form' method='post' >
                      ...
                      <option value='No'> No factible</option>
											...
											<td align='center'><input name='obs_tutor[]' style="width:170px" size="15" class="form-control" maxlength="60" placeholder="Maximo 60 caracteres"/></td>                                          
											<td align='center'>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <center><h3 class="box-title">Verificar plagio de proyecto</h3></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$sql="SELECT *,estudiante.ci AS'ci_est',proyectos.id,nomb_pnf,
trayectos.descripcion,secciones.num_seccion,anios.periodo,turnos.descripcion AS'des_tur'
...
?>				<?php while($row=mysql_fetch_array($r)){ ?>
               ...
               <td class="text-center" ><?php echo $row['descripcion'];?></p></td>
               ...
               <td ><p align='center'><?php echo $row['des_tur'];?></p></td>
                  <td><a target="_blank" href="planilla_inscripcion.php?id=<?php echo $row['id'];?>" ><img src="imagenes/pdf.png" style="width:30px; height:30 px;" ></a></td>
                </tr>
															<?php }
