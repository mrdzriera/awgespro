...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Permisos/Desbloquear usuarios  
      </h1>

         <form action="lista_bloqueados.php" name="form" method="post">
         ...
         <div class="col-md-8 col-md-offset-2">  
                ...
                <div class="box box-info">
					 ...
					 <center><strong>Usuarios Bloqueados</strong></center>
					 <br>
                    ...
                    <div class="box-body">
                        ...
                        <br>
                  <label for="inputEmail3" class="col-sm-4 control-label" align="right">tipo de usuario:</label>
                ...
                <button type="submit" class="btn btn-info pull-right" onclick="ValidarCadenaExpReg();"> <i class="fa fa-share" aria-hidden="true"></i>
                Continuar </button>
              </div>
