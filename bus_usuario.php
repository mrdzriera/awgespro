...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    extract($_REQUEST);
      ...
      $busqueda="SELECT * FROM profesores,usuarios WHERE 
      profesores.ci=usuarios.ci AND
      nivel='Administrador' AND
      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        ?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="usuario_modificado.php" onsubmit="return validaarchivo();" name="form" enctype='multipart/form-data' method="post">
