...
$id_operacion=$_POST['id_operacion'][$i];	
$id_permiso=$_POST['id_permiso'][$i];	


$consulta="UPDATE usuario_tiene_permiso SET id_permiso='".$_POST['id_permiso'][$i]."' WHERE 
id_usuario='".$_POST['id_usuario'][$i]."' AND id_operacion='".$_POST['id_operacion'][$i]."' ";
...
<?php
	   ...
	   $(document).ready(function(){
		swal("Bien!", "El privilegio de los usuarios ha sido determinado exitosamente", "success");
		});
