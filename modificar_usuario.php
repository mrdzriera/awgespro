     ...
     <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <h2 class="panel-title text-center">Todos los campos con (<img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; ">) son obligatorios</h2>
             ...
             <div class="box-header with-border">
            <center> <b>¡IMPORTANTE!</b> <br> Para modificar los niveles de usuario  debe confirmar la contrase&ntilde;a del administrador</center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="modificar_nivel.php" name="form" method="post">
