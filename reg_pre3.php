...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     Registros/Presentaciones/M&oacute;dulo 3</h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Asignar fechas de presentaci&oacute;n en el m&oacute;dulo 3</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  <?php
...
swal("Disculpe Usted aun no esta autorizado para registrar presentaciones!");
});
...
sedes.nombre
FROM proyectos,profesores,coord_tiene_proy,defensas,estudiante,sedes,est_cursa_proy,est_tiene_proy WHERE 
...
defensas.hora_entrada='00:00:00' AND
defensas.modulo='3' ";
$r=mysql_query($sql);
...
<script language="javascript">
 $(document).ready(function(){
sweetAlert("Disculpe", "Usted no tiene proyectos pendientes por asignar fecha de presentacion en la fase 3", "error");
});
function redireccionar(){
window.location="consulta_defensa.php";
}
...
?>
              <form action='pres_registrada3.php' name='form' method='post' >
        ...
        <option value="Usos multiples">Usos multiples</option>
				...
				<input type='hidden' name='modulo[]' value='3' size='1' max-length='20' placeholder='Cedula Estudiantil' readonly title='Cedula'/>
