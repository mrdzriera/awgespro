...
window.location="consulta_jurado_ct.php";
}
...
<tr>
	...
	<tbody>
	<tr>
    <td><?php echo $row['titulo'];?></center></td>
...
<table  class="table table-bordered table-striped" >
		 <thead>
  <tr>
	<td><center><strong>Coordinador(a)</strong></center></td>
	<td><center><strong>&nbsp;Tutor(a)</strong></center></td>
