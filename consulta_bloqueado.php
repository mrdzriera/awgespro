...
<form action="mostrar_usuario2.php" name="form" method="post">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <br>
                  <label for="inputEmail3" class="col-sm-4 control-label" align="right">C.I. del usuario</label>

                     <div class="col-sm-7">
                    <input class="form-control" placeholder="1234678" name="ci" id="inputEmail3"  type="text" onkeypress="return solonumeros(event);" onpaste="return false" maxlength="8">
