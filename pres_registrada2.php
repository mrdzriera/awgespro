...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h1 class="panel-title text-center">
      Registros/Presentaciones/M&oacute;dulo 2    
      </h1>
    </section>
...
DEL SEGUNDO MODULO PARA QUE DICHA FECHA NO SEA IGUAL
A LA DEL PRIMERO*/
...
//VALIDACION PARA VER SI TIENE TUTOR EL PROYECTO
...
//VALIDACION PARA SABER SI TIENE FECHA DE PRESENTACION EN LA FASE 1
$con="SELECT * FROM defensas WHERE modulo='1' AND id_proyecto='".$id_proyecto."' AND fecha!='0000-00-00' ";
...
<?php	
}else if(mysql_num_rows($verifico)==0){
?>
<script type="text/javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "Aun no puede registrar la fecha de presentacion de la fase 2", "error");
});
function redireccionar(){
...
<?php
}else if(($mes!=6)and($mes!=7)and($mes!=9)and($mes!=10)){
?>
<script language="javascript">
$(document).ready(function(){
sweetAlert("Disculpe", "ingrese una fecha entre los meses de junio a octubre", "error");
});
function redireccionar(){
window.location="reg_pre2.php";
}
...
$sql="UPDATE defensas SET fecha='".$_POST['fecha'][$i]."',hora_entrada='".$_POST['hora_entrada'][$i]."',lugar='".$_POST['lugar'][$i]."' WHERE id_proyecto='".$_POST['id_proyecto'][$i]."' AND modulo='2' ";
$r=mysql_query($sql);
//echo $sql;
if($r==0){
?>
...
<script type="text/javascript">
$(document).ready(function(){
swal("Bien!", "La fecha de presentacion de la fase 2 ha sido asignada exitosamente", "success");
});
function redireccionar(){
...
$sql="INSERT INTO historial VALUES ('null',".$_SESSION['id_usu'].",  'EL USUARIO QUE ASIGNO LA FECHA DE PRESENTACION EN LA FASE 2 TIENE ESTE ID:".$_SESSION['id_usu']. "','".date("Y-m-d")."','".date("h:i")."')";
//echo $sql;
mysql_query($sql);
}
