...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      Mantenimiento/Restaurar base de datos
      </h1>
         ...
         <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box box-info">
            ...
            <h2 class="panel-title text-center">Todos los campos con (<img src="imagenes/asterisco.jpg" style=" width:15px;  height:15px; ">) son obligatorios</h2>
               ...
               <div class="box-header with-border">
            <center><b>¡IMPORTANTE!</b> <br> Para restaurar la base de datos debe confirmar la contrase&ntilde;a del administrador</center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="mostrar_restore.php" name="form" method="post">
