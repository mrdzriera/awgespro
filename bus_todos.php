        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="panel-title text-center">Proyectos donde usted es comit&eacute; t&eacute;cnico en general</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 <?php
